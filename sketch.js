...
function draw() {
  ...
  reset()
   ...
   if(!hit && (ball.isTouching(goalpost1) || ball.isTouching(goalpost2) || ball.isTouching(goalpost))){
    ball.velocityX = 0
    ball.velocityY = 0
    score = score+1
    hit = true
   ...
   if(ball.isTouching(player1) || ball.isTouching(player2) || ball.isTouching(player3) || ball.isTouching(player4) || ball.isTouching(goalkeeper)){
    ball.velocityX = 0
    ball.velocityY = 0
    reset() 
   }
